...
script "install_chf9010002" do
  ...
  code <<-EOH
  unzip CF901.zip
  cp CF901/lib/updates/chf9010002.jar #{node['cf9']['install_path']}/lib/updates   
  unzip -o CFIDE-901.zip -d #{node['cf9']['install_path']}/wwwroot
  unzip -o CF901/WEB-INF.zip -d #{node['cf9']['install_path']}/wwwroot  
  cp -f CF901/lib/*.jar #{node['cf9']['install_path']}/lib 
  cp -f CF901/lib/*.properties #{node['cf9']['install_path']}/lib  
  chown -R nobody:bin #{node['cf9']['install_path']}/wwwroot
